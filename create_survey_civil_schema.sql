...
CREATE INDEX IF NOT EXISTS idx_control_membership_network ON control_point_membership(network_id);
CREATE INDEX IF NOT EXISTS idx_control_membership_point ON control_point_membership(point_id);
...
CREATE INDEX IF NOT EXISTS idx_site_trees_project ON site_trees(project_id);
CREATE INDEX IF NOT EXISTS idx_utility_structures_project ON utility_structures(project_id);
CREATE INDEX IF NOT EXISTS idx_utility_structures_geom ON utility_structures USING GIST(rim_geometry);
CREATE INDEX IF NOT EXISTS idx_surface_features_project ON surface_features(project_id);
CREATE INDEX IF NOT EXISTS idx_surface_features_geom ON surface_features USING GIST(geometry);
...
CREATE INDEX IF NOT EXISTS idx_alignments_project ON horizontal_alignments(project_id);
CREATE INDEX IF NOT EXISTS idx_alignments_geom ON horizontal_alignments USING GIST(alignment_geometry);
CREATE INDEX IF NOT EXISTS idx_alignment_pis_alignment ON alignment_pis(alignment_id);
CREATE INDEX IF NOT EXISTS idx_vertical_profiles_alignment ON vertical_profiles(alignment_id);
CREATE INDEX IF NOT EXISTS idx_profile_pvis_profile ON profile_pvis(profile_id);
...
CREATE INDEX IF NOT EXISTS idx_cross_sections_station ON cross_sections(station);
CREATE INDEX IF NOT EXISTS idx_xsection_points_section ON cross_section_points(section_id);
CREATE INDEX IF NOT EXISTS idx_earthwork_quantities_alignment ON earthwork_quantities(alignment_id);
CREATE INDEX IF NOT EXISTS idx_earthwork_balance_alignment ON earthwork_balance(alignment_id);
...
CREATE INDEX IF NOT EXISTS idx_utility_lines_project ON utility_lines(project_id);
CREATE INDEX IF NOT EXISTS idx_utility_lines_system ON utility_lines(utility_system);
CREATE INDEX IF NOT EXISTS idx_utility_lines_geom ON utility_lines USING GIST(geometry);
CREATE INDEX IF NOT EXISTS idx_utility_lines_from ON utility_lines(from_structure_id);
CREATE INDEX IF NOT EXISTS idx_utility_lines_to ON utility_lines(to_structure_id);
...
CREATE INDEX IF NOT EXISTS idx_parcels_geom ON parcels USING GIST(boundary_geometry);
CREATE INDEX IF NOT EXISTS idx_parcel_corners_parcel ON parcel_corners(parcel_id);
CREATE INDEX IF NOT EXISTS idx_easements_project ON easements(project_id);
CREATE INDEX IF NOT EXISTS idx_easements_geom ON easements USING GIST(boundary_geometry);
CREATE INDEX IF NOT EXISTS idx_row_project ON right_of_way(project_id);
CREATE INDEX IF NOT EXISTS idx_row_geom ON right_of_way USING GIST(boundary_geometry);
...
CREATE INDEX IF NOT EXISTS idx_survey_observations_session ON survey_observations(session_id);
CREATE INDEX IF NOT EXISTS idx_traverse_loops_project ON traverse_loops(project_id);
...
CREATE INDEX IF NOT EXISTS idx_grading_limits_project ON grading_limits(project_id);
CREATE INDEX IF NOT EXISTS idx_grading_limits_geom ON grading_limits USING GIST(boundary_geometry);
CREATE INDEX IF NOT EXISTS idx_pavement_sections_project ON pavement_sections(project_id);
CREATE INDEX IF NOT EXISTS idx_pavement_sections_alignment ON pavement_sections(alignment_id);
CREATE INDEX IF NOT EXISTS idx_surface_models_project ON surface_models(project_id);
CREATE INDEX IF NOT EXISTS idx_surface_models_geom ON surface_models USING GIST(bounding_box);
CREATE INDEX IF NOT EXISTS idx_typical_sections_project ON typical_sections(project_id);
