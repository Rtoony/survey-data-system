...
class DXFLookupService:
    ...
    def get_or_create_layer(self, layer_name: str, project_id: str = None,
        ...
        Args:
            ...
            project_id: UUID of the project (required for project-level layers)
    ...
    def record_layer_usage(self, project_id: str, layer_id: str,
        ...
        DEPRECATED: This function is a no-op. The drawing_layer_usage table
        was removed in Migration 009. Layer usage is now tracked through
        direct entity counts in the layers table.
        ...
        """
        # No-op - drawing_layer_usage table removed in Migration 009
        pass
    ...
    def record_linetype_usage(self, project_id: str, linetype_name: str,
        ...
        DEPRECATED: This function is a no-op. The drawing_linetype_usage table
        was removed in Migration 009. Linetype usage is now tracked through
        direct references in entity tables.
        ...
        """
        # No-op - drawing_linetype_usage table removed in Migration 009
        pass
