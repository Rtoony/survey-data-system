...
# ============================================
# NOTE: Core utilities moved to app/utils/core_utilities.py during Phase 13 refactoring
...
# NOTE: Classification page routes moved to app/blueprints/classification.py during Phase 13
...
# NOTE: Classification API routes moved to app/blueprints/classification.py during Phase 13
...
# NOTE: Blocks management routes moved to app/blueprints/blocks_management.py during Phase 13

# NOTE: Details management routes moved to app/blueprints/details_management.py during Phase 13
...
# NOTE: Pipe networks routes moved to app/blueprints/pipe_networks.py during Phase 13
...
# NOTE: Survey codes routes moved to app/blueprints/survey_codes.py during Phase 13
...
# NOTE: Specialized tools routes moved to app/blueprints/specialized_tools.py during Phase 13
